...
Class CQueryRestrictionCoverage
    Inherits CQueryRestrictionTest
    ...
    End Function
    Shared Sub RestrictionMain(ByVal path As String)
        Dim arrayList, arrayTestList, validArrayTestList As New List(Of String)
        arrayTestList = ShowMethods(GetType(CQueryRestrictionTest))
        arrayList = ShowMethods(GetType(CQueryRestriction))
        Dim className = GetType(CQueryRestriction).Name
