...
Class CQueryCentreCoverage
    Inherits CQueryCentreTest
    ...
    End Function
    Shared Sub CentreMain(ByVal path As String)
        Dim arrayList, arrayTestList, validArrayTestList As New List(Of String)
        arrayTestList = ShowMethods(GetType(CQueryCentreTest))
        arrayList = ShowMethods(GetType(CQueryCentre))
        Dim className = GetType(CQueryCentre).Name
