...
Class CQueryCategoryCoverage
    Inherits CQueryCategoryTest
    ...
    End Function
    Shared Sub CategoryMain(ByVal path As String)
        Dim arrayList, arrayTestList, validArrayTestList As New List(Of String)
        arrayTestList = ShowMethods(GetType(CQueryCategoryTest))
        arrayList = ShowMethods(GetType(CQueryCategory))
        Dim className = GetType(CQueryCategory).Name
