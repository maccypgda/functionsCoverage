...
Class CQuerySurveyCoverage
    Inherits CQuerySurveyTest
    ...
    End Function
    Shared Sub SurveyMain(ByVal path As String)
        Dim arrayList, arrayTestList, validArrayTestList As New List(Of String)
        arrayTestList = ShowMethods(GetType(CQuerySurveyTest))
        arrayList = ShowMethods(GetType(CQuerySurvey))
        Dim className = GetType(CQuerySurvey).Name
